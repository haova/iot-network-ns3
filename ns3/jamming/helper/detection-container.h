...
#ifndef DETECTION_CONTAINER_H
#define DETECTION_CONTAINER_H
...
{
public:
  typedef std::vector< Ptr<Detection> >::const_iterator Iterator;
...
public:
   ...
   */
  DetectionContainer (Ptr<Detection> mitigation);
   ...
   */
  DetectionContainer (std::string mitigationName);
   ...
   */
  DetectionContainer (const DetectionContainer &a,
   ...
   */
  Ptr<Detection> Get (uint32_t i) const;
   ...
   */
  void Add (DetectionContainer container);
   ...
   * \param source Pointer to an JammingMitigation.
   */
  void Add (Ptr<Detection> mitigation);
...
private:
  std::vector< Ptr<Detection> > m_mitigators;
