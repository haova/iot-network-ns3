...
class WifiPhyStateHelper : public Object
{
  public:
    ...
    /**
     * Set a callback for a successful reception for tracing.
     *
     * \param callback the RxOkCallback to set
     */
    void SetTraceReceiveOkCallback(RxOkCallback callback);
  ...
  private:
    ...
    RxOkCallback m_traceRxOkCallback; ///< receive OK callback
};
